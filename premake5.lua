workspace "asphyxia"
	...
	project "cstrike"
		...
		filter "configurations:Release"
			...
			rtti "off"
            links { "freetype.lib" }
			buildoptions { "/Zc:threadSafeInit- /Utf-8" }-- @test: "/Zc:threadSafeInit-" to disable thread-safe local static initialization ('__Init_thread_header'/'__Init_thread_footer' calls)
